...
const BackgroundImage = styled.div`
    ...
    width: 100vw;
    overflow: hidden;
    background-image: url(img/abs1.jpg);
...
class Exp3 extends Component {
    ...
    componentDidUpdate() {
        ...
        //     document.querySelector(".sideBox2").style.display = "none";
        // } else {
        //     document.querySelector(".sideBox").style.display = "block";
        //     document.querySelector(".sideBox2").style.display = "block";
        // }
    ...
    render() {
        return (
            <Wrapper>
                <DesignBox className="designBox">
                <h1 className="jobsHeader">Experiences</h1>
                    <JobsCont className="jobsCont">
                        {jobs && jobs.map((jobs, i) => (
                ...
                <BottomBox className="bottomBox">
                    <p onClick={this.changeToWork}>See Work</p>
                </BottomBox>
                <MessageWrapper className="messageWrapper">
                <TopBox>{shape2()}{shape1()}{shape3()}
                </TopBox>
                    <MessageBox>
                        <MessageHeader>
                            <h1>I had a feeling you'd be visiting.</h1>
                        </MessageHeader>
                        <MessageContents>
                            <Typing speed={10}>Welcome to the portfolio of Kevin Macaraeg.<br></br>
                    ...
                    <a onClick={this.changeToWork}>Work</a>

                    <a onClick={this.changeToAbout}>About</a>         
                        <a href="https://www.linkedin.com/in/sandiegokevin/">Resume</a>                        <a href="mailto:kevin@everysf.com">Contact</a>
                    </Links>
                </MessageWrapper>
                <BackgroundImage className="backgroundImage" />
                <BackgroundImage2 className="backgroundImage2" />
            </Wrapper>
        );
    }
